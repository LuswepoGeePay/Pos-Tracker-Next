...
// import EditPosDeviceDialog from '@/components/custom/dialogs/posDevicevs/edit-version-dialog'
// import ViewPosDeviceDialog from '@/components/custom/dialogs/posDevicevs/view-version-dialog'
  ...
  const fetchPosDevices = async () => {
    ...
    if (responseBody["status"] === "success") {
      if (responseBody?.devices?.posdevice) {
        ...
        setTotalPages(responseBody.posDevices.totalPages || 0);
    ...
    <main className='m-10'>
      ...
      <Card className='w-[340px] md:w-full my-20'>
        ...
        <CardContent className='p-8'>
          ...
          {/* <ViewPosDeviceDialog
            posDevice={viewPosDevice}
            open={!!viewPosDevice}
            onClose={() => setViewPosDevice(null)}
          />
          <EditPosDeviceDialog
            PosDevice={editPosDevice}
            open={!!editPosDevice}
